...
date -d @1520000000  # convert unix epoch ISO time
    date '+%m-%d-%Y---%H-%M-%S'    # print current time in format "08-26-5881---09-48-43"
    date -r 123439819723 '+%m/%d/%Y:%H:%M:%S' # prints "08/26/5881:09:48:43"
    date -r 123439819723 # prints "Fri Aug 26 09:48:43 CDT 5881"
